...
//           <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Start a Project</h2>
//           <p className="text-muted-foreground">Tell me about your project and let’s work together.</p>
//         </div>
...
//           >
//             <h3 className="text-xl font-bold mb-6">Tell Me About Your Project</h3>
...
//                 ) : (
//                   <>
//                     Send Project Details <Send className="w-4 h-4" />
//                   </>
//                 )}
//               </button>
//             </form>
...
export function Guestbook() {
  ...
  return (
  <section id="guestbook" className="py-28 bg-white/[0.02]">
  <div className="container mx-auto px-4 max-w-3xl">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-muted-foreground text-lg max-w-xl mx-auto">
        Share your vision. I’ll help you turn it into a powerful, scalable digital product.
      </p>
    </div>
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-card p-10 rounded-3xl border border-white/10 shadow-2xl"
    >
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-background border border-white/10 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition"
          />
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-xl bg-background border border-white/10 focus:border-primary outline-none transition"
        />

        {/* Project Type */}
        <select
          {...form.register("projectType")}
          className="w-full px-4 py-3 rounded-xl bg-background border border-white/10 focus:border-primary outline-none"
        >
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <option value="80k-2L">₹80k – ₹2L</option>
        ...
        <textarea
          ...
          placeholder="Key features required (Login system, Payment integration, Admin panel, etc.)"
          rows={3}
          className="w-full px-4 py-3 rounded-xl bg-background border border-white/10 focus:border-primary outline-none resize-none"
        />

        {/* Full Description */}
        <textarea
          {...form.register("message")}
          placeholder="Describe your project in detail. What problem are you solving? Target audience? Inspiration?"
          rows={5}
          className="w-full px-4 py-3 rounded-xl bg-background border border-white/10 focus:border-primary outline-none resize-none"
        />
        ...
        <button
          type="submit"
          disabled={createMutation.isPending}
          className="w-full py-4 rounded-xl font-semibold text-lg bg-gradient-to-r from-primary to-accent text-white shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 flex items-center justify-center gap-2"
        >
          {createMutation.isPending ? (
            <Loader2 className="w-5 h-5 animate-spin" />
          ) : (
